...
export function DecisionEnginePanel({ sample, preview, lastStep }: Props) {
      ...
      <div className="glass rounded-2xl p-5">
        <div className="mb-3 flex items-center justify-between">
          ...
          <Tooltip>
            ...
            <TooltipContent>Class probabilities from the current model.</TooltipContent>
          </Tooltip>
        </div>
        {sample ? (
          ...
          <EmptyHint label="No active sample. Start the experiment." />
        )}
      </div>
      ...
      >
        ...
        {preview && (
          <div className="mt-3 grid grid-cols-2 gap-3 text-xs">
            <div>
              <div className="text-muted-foreground">Expected reward</div>
              <div className="font-mono-num text-base font-semibold text-success">
                {preview.expectedReward >= 0 ? "+" : ""}
